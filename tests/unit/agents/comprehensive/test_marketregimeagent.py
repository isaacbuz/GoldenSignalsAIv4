#!/usr/bin/env python3
"""
Comprehensive tests for Market Regime Classification Agent
"""
...
from agents.core.market_regime_agent import MarketRegimeClassificationAgent
from agents.core.market_regime_agent import MarketRegime, RegimeIndicators
from src.ml.models.market_data import MarketData
from src.ml.models.signals import SignalType

class TestMarketRegimeAgent:
    """Comprehensive tests for MarketRegimeAgent."""
    
    def test_initialization(self):
        """Test agent initialization."""
        agent = MarketRegimeAgent()
        assert agent is not None
        assert agent.name == "Market Regime"
