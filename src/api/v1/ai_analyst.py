...
async def analyze_query(
    query: str, context: Optional[Dict[str, Any]] = None, session_id: Optional[str] = None
) -> Dict[str, Any]:
    """
...
async def analyze_technical(
    symbol: str, timeframe: str = "1h", indicators: Optional[List[str]] = None
) -> Dict[str, Any]:
    """
...
async def analyze_sentiment(symbol: str) -> Dict[str, Any]:
    ...
    context = {"analysis_type": "sentiment", "symbol": symbol}
...
async def analyze_patterns(
    symbol: str, timeframe: str = "1h", pattern_types: Optional[List[str]] = None
) -> Dict[str, Any]:
    """
...
async def analyze_risk(
    symbol: str, position_type: Optional[str] = None, position_size: Optional[float] = None
) -> Dict[str, Any]:
    """
...
async def compare_symbols(
    symbols: List[str], metrics: Optional[List[str]] = None, timeframe: str = "1d"
) -> Dict[str, Any]:
    """
...
async def predict_price(symbol: str, timeframe: str = "1d", horizon: str = "1w") -> Dict[str, Any]:
    """
...
async def analyze_chart_image(image_data: str, context: Optional[str] = None) -> Dict[str, Any]:
    """
        ...
        while True:
            ...
            if data.get("type") == "query":
                ...
                try:
                    ...
                    await websocket.send_json(
                        {"type": "error", "message": f"Analysis error: {str(e)}"}
                    )
                ...
                await websocket.send_json({"type": "status", "message": "Analyzing your chart..."})
                ...
                try:
                    ...
                    await websocket.send_json(
                        {"type": "error", "message": f"Chart analysis error: {str(e)}"}
                    )
