...
class ErrorTrackingService:
    ...
    def _sanitize_data(self, data: Any) -> Any:
        ...
        if isinstance(data, dict):
            ...
            return {k: '[REDACTED]' if any(field in k.lower() for field in sensitive_fields) else v 
    ...
    def set_trading_context(self, symbol: str, action: str, 
    ...
    def set_agent_context(self, agent_name: str, agent_type: str, 
