...
class SmartCacheService:
    ...
    async def get(
        self, data_type: DataType, key: str, fetch_func: Optional[Callable] = None
    ) -> Optional[Any]:
    ...
    async def _set_to_database(self, key: str, data: Any, ttl: int):
        ...
        self.db_cache[key] = {"data": data, "expires": time.time() + ttl}
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "memory_size": {dt.value: len(cache) for dt, cache in self.memory_cache.items()},
        }
