...
class ChartGeneratorService:
    ...
    async def create_multi_timeframe_chart(
        self, symbol: str, timeframes: List[str], sync_crosshair: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    async def create_volume_profile_chart(
        self, symbol: str, timeframe: str, show_poc: bool = True, show_value_areas: bool = True
    ) -> Dict[str, Any]:
        """
        ...
        chart_config = {
            ...
            "series": [{"type": "candlestick", "id": "price", "name": f"{symbol} Price"}],
            "volume_profile": {
                "enabled": True,
                "position": "right",
                "width": 0.15,
    ...
    async def create_options_flow_chart(self, symbol: str, timeframe: str = "5m") -> Dict[str, Any]:
        """
        ...
        chart_config = {
            ...
            "symbol": symbol,
            "timeframe": timeframe,
            "layout": {"backgroundColor": self.color_scheme["background"]},
            "series": [
                {"type": "candlestick", "id": "price", "name": f"{symbol} Price", "pane": 0},
                {
                    "type": "histogram",
                    "id": "call_volume",
                    "name": "Call Volume",
    ...
    async def create_correlation_heatmap(
        self, symbols: List[str], timeframe: str = "1d", period: int = 30
    ) -> Dict[str, Any]:
        """
    ...
    async def create_market_structure_chart(self, symbol: str, timeframe: str) -> Dict[str, Any]:
        """
        ...
        chart_config = {
            ...
            "overlays": [
                ...
                {"type": "trend_lines", "autoDetect": True, "color": self.color_scheme["primary"]},
                {
    ...
    def generate_chart_annotations(self, analysis_results: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
...
async def test_chart_generator():
    ...
    mtf_chart = await generator.create_multi_timeframe_chart(
        symbol="SPY", timeframes=["5m", "1h", "1d"], sync_crosshair=True
    )
