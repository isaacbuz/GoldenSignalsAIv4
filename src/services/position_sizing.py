...
class PositionSizingService:
    ...
    def calculate_position_size(
        ...
        position_pct = max(
            ...
            min(adjusted_kelly, self.max_position_pct)
        )
    ...
    def _generate_reasoning(
        ...
        if kelly_pct > 0:
            ...
            reasoning_parts.append(
                "Kelly suggests no position (negative expectancy)"
            )
        
        # Conservative adjustment
        reasoning_parts.append(
            f"Applied {self.kelly_fraction*100:.0f}% Kelly fraction for safety"
        )
        
        # Final size
        reasoning_parts.append(
            f"Final position size: {final_size*100:.1f}% of capital"
        )
    ...
    def calculate_portfolio_heat(
        ...
        return {
            ...
            'remaining_risk_capacity': max(0, (capital * 0.06) - total_risk)  # 6% max portfolio heat
        }
