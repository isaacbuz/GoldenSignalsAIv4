...
# Define data classes needed for mock service
...
class MockMarketDataService:
    ...
    def __init__(self):
        ...
        # Technical indicators will be calculated on demand
    ...
    def fetch_real_time_data(
        self, symbol: str
    ) -> Tuple[Optional[MarketTick], Optional[MarketDataError]]:
    ...
    ) -> Tuple[pd.DataFrame, Optional[MarketDataError]]:
