...
class MLSignalGenerator:
    ...
    async def _fetch_market_data(self, symbol: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            return {
                ...
                "change_percent": (
                    (historical[-1]["close"] - historical[0]["close"]) / historical[0]["close"]
                )
                * 100,
    ...
    async def _analyze_with_agent(
        self, agent: Any, symbol: str, market_data: Dict[str, Any]
    ...
    def _combine_signals(
        self, symbol: str, agent_signals: Dict[str, Dict[str, Any]], market_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            pattern = patterns.get(
                primary_agent.replace("Agent", "").lower(), "Multi-Signal Convergence"
            )
