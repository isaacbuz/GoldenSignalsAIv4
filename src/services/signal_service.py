...
class SignalService:
    ...
    async def get_latest_signals(self, symbol: str, limit: int = 10) -> List[Any]:
        """
        ...
        try:
            ...
            signals = await self.db_manager.get_signals(symbol=symbol, limit=limit)
    ...
    async def update_signal_performance(
        ...
        try:
            ...
            success = await self.db_manager.update_signal_performance(signal_id, performance_data)
    ...
    async def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "avg_signal_confidence": sum(s.confidence for s in recent_signals)
                / len(recent_signals)
                if recent_signals
                else 0,
