...
class CacheManager:
    ...
    async def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "l1_hit_rate": (self.metrics["l1_hits"] / self.metrics["hits"] * 100) if self.metrics["hits"] > 0 else 0,
            **self.metrics
        }
    
    async def warm_cache(self, namespace: str, keys: List[Union[str, dict]], values: List[Any], ttl: Optional[int] = None):
...
class CachedDataLoader:
    ...
    async def _fetch_market_data(self, symbols: List[str], start: datetime, end: datetime) -> Dict[str, Any]:
