...
class AsyncBatchProcessor:
    ...
    async def process_batch(self, items: List[Any], processor: Callable[[Any], Any]) -> List[Any]:
        ...
        async with self.semaphore:
            ...
            for item in items:
                if asyncio.iscoroutinefunction(processor):
                    ...
                    task = asyncio.get_event_loop().run_in_executor(None, processor, item)
                tasks.append(task)

            return await asyncio.gather(*tasks)

    async def process_all(self, items: List[Any], processor: Callable[[Any], Any]) -> List[Any]:
