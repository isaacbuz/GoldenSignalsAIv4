...
class OptionsAnalysis:
    ...
    def _analyze_implied_volatility(self, options_chain: pd.DataFrame) -> Dict:
        ...
        try:
            ...
            atm_iv = options_chain[options_chain["strike"] == atm_strike][
                "implied_volatility"
            ].iloc[0]
            ...
            iv_rank = (atm_iv - options_chain["implied_volatility"].min()) / (
                options_chain["implied_volatility"].max()
                - options_chain["implied_volatility"].min()
            )
    ...
    def _analyze_options_flow(self, options_chain: pd.DataFrame) -> Dict:
        ...
        try:
            ...
            large_trades = options_chain[
                options_chain["volume"] > options_chain["volume"].quantile(0.9)
            ]
