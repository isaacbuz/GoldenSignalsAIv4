...
class PerformanceAnalytics:
    ...
    def analyze_trades(self, trades: pd.DataFrame) -> Dict[str, Dict]:
        ...
        try:
            analysis = {"overall": {}, "by_symbol": {}, "by_signal": {}}
            ...
            analysis["overall"] = {
                ...
                "avg_hold_time": (trades["exit_time"] - trades["entry_time"]).mean().total_seconds()
                / 86400,  # in days
            }
            ...
            for signal in trades["signal_type"].unique():
                ...
                analysis["by_signal"][signal] = {
                    ...
                    "avg_profit": signal_trades[signal_trades["pnl"] > 0]["pnl"].mean()
                    if len(signal_trades[signal_trades["pnl"] > 0]) > 0
                    else 0,
