...
class BacktestReporter:
    ...
    def _generate_detailed_metrics(self, metrics: BacktestMetrics) -> Dict[str, Any]:
        ...
        percentage_fields = [
            'total_return', 'annualized_return', 'benchmark_return',
            'alpha', 'volatility', 'downside_volatility', 'max_drawdown',
            'var_95', 'cvar_95', 'win_rate', 'exposure_time'
        ]
        ...
        ratio_fields = [
            ...
            'information_ratio', 'profit_factor', 'payoff_ratio', 'beta'
        ]
