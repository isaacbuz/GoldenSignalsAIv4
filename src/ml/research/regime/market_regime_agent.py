...
class MarketRegimeAgent(BaseAgent):
    ...
    def classify_regime(self, features: pd.DataFrame, model: GaussianMixture) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"regime": current_regime, "probability": current_prob}
        ...
        try:
            ...
            if features.empty:
                return {
                    "action": "hold",
                    "confidence": 0.0,
                    "metadata": {"error": "Insufficient data for regime detection"},
                }
            ...
            if self.model is None:
                return {
                    "action": "hold",
                    "confidence": 0.0,
                    "metadata": {"error": "Failed to fit regime model"},
                }
