...
class WebSocketManager:
    ...
    async def connect(
        ...
        try:
            ...
            logger.info(
                f"WebSocket connection established: {connection_id} (user: {user_id}, type: {connection_type})"
            )
            return True
    ...
    async def send_to_connection(
        self, connection_id: str, message: Union[Dict[str, Any], str]
    ) -> bool:
        """
    ...
    async def broadcast_to_all(
        self, message: Union[Dict[str, Any], str], connection_type: Optional[str] = None
    ) -> int:
        """
    ...
    async def broadcast_to_symbol_subscribers(
        self, symbol: str, message: Union[Dict[str, Any], str]
    ) -> int:
        """
    ...
    async def broadcast_to_user(self, user_id: str, message: Union[Dict[str, Any], str]) -> int:
        """
