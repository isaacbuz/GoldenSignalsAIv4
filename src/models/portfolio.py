...
class Portfolio(BaseModel):
    ...
    def add_trade(self, symbol: str, action: str, quantity: int, price: float, signal_id: str = None):
    ...
    def calculate_position_size(self, symbol: str, price: float, risk_amount: float):
        ...
        if self.position_sizing == "equal":
            ...
            avg_loss = abs(self.total_pnl) / max(self.losing_trades, 1) if self.losing_trades > 0 else 1
